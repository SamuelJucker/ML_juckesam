...
# #     """
# #     summary = summarize(text)
# #     print(summary)  # Moved inside the if-block to ensure it's only called when files are present.
# from transformers import AutoTokenizer, AutoModelForSeq2SeqLM, GenerationConfig
# import os
...
# # Debugging: print the current working directory and list files in model_directory
# print(f"Current working directory: {os.getcwd()}")
# print(f"Contents of '{model_directory}': {os.listdir(model_directory) if os.path.exists(model_directory) else 'Directory does not exist'}")
...
try:
    ...
    raise ImportError("PyTorch is not installed. Please install it from https://pytorch.org/get-started/locally/")
